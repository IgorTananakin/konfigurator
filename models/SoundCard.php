...
class SoundCard extends \yii\db\ActiveRecord
{
      ...
      public function getImageUrl()
      {
           if ($this->image == '') 
           {
              ...
              $str_image='<img src="/uploads/SoundcardController/thumbnail-200x200/' . $this->image .' "  class="button12" />';
          }
          return $str_image;
...
public function upload() {
    ...
    //$this->image->saveAs('uploads/CorpusController/' . $this->image->baseName . '.' . $this->image->extension);
        ...
        Image::thumbnail('uploads/SoundcardController/' .
         $this->image->baseName. '.' . $this->image->extension, 200, 200)
                ->resize(new Box(200,200))
                ->save('uploads/SoundcardController/thumbnail-200x200/' . $this->image->baseName . '.' . $this->image->extension, 
                        ['quality' => 70]);
